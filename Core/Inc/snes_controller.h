...
#define SNES_SELECT_MASK 0x2000     // 0b0010000000000000
#define SNES_START_MASK 0x1000      // 0b0001000000000000
#define SNES_UP_MASK 0x0800         // 0b0000100000000000
#define SNES_DOWN_MASK 0x0400       // 0b0000010000000000
#define SNES_LEFT_MASK 0x0200       // 0b0000001000000000
#define SNES_RIGHT_MASK 0x0100      // 0b0000000100000000
#define SNES_A_MASK 0x0080          // 0b0000000010000000
#define SNES_X_MASK 0x0040          // 0b0000000001000000
#define SNES_L_MASK 0x0020          // 0b0000000000100000
#define SNES_R_MASK 0x0010          // 0b0000000000010000
